...
const Home = ({ items,addcart,id}) => {
  ...
  return ( 
    ...
    <div className="row">
  {items.map((products) => (
      <div className='col-lg-3 col-md-6 col-sm-6 mb-3' key={products.id}>
        <div className='card d-flex align-items-center justify-content-center border rounded-start bg-light'>
          ...
          <div className='card-body'>
            <h5 className='card-title h6' title={products.title}>{(products.title).substring(0,20)}..</h5>
